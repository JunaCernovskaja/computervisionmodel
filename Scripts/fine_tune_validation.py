...
def validate_model():
    ...
    validation_dir = os.path.join(base_dir, 'handpicked_dataset/train')
    ...
    try:
        ...
        model_path = os.path.join(base_dir, 'fine_tuned_war_photography_classifier_efficientnet.keras')
